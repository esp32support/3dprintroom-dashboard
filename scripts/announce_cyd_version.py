...
"Update available" card both notice the new build - see cloud_publish.cpp's
own comment on that topic. Does NOT trigger a flash by itself; that still
needs an explicit tap (on-device or the dashboard's remote trigger).
