...
//
// /api/gcode-sync, /api/device-filament, /api/printer-watch-state and
// /api/fix-slot-assignment are meant to be called by scripts/devices with
...
const PUBLIC_PATHS = new Set([
    ...
    "/api/fix-slot-assignment", "/app.js",
]);
