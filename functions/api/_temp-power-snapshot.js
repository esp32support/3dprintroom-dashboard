// GET /api/_temp-power-snapshot - TEMP, read-only, deleted after use.
// Same as _temp-printer-snapshot.js but for the POWER_TOPIC, to check the
// actual relay state (was auto-off responsible for "unreachable" simply
// because the printer is genuinely powered off, not a CYD bug at all).
...
export async function onRequestGet(context) {
    ...
    const topic = `${env.MQTT_TOPIC}/power`;
