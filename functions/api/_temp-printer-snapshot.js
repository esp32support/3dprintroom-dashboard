...
// JSON, so it can be diffed across calls a few minutes apart - the
// established diagnostic for the "CYD publish path stuck" bug class (see
// memory cyd-silent-publish-failure): if the retained "now" timestamp is
// byte-identical across calls made minutes apart, CYD has stopped
// actually publishing (screen may still look fine - it reads Bambu Cloud
// directly, a separate path).
